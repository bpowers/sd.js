...
(function(e,t){typeof define=="function"&&define.amd?define(t):e.sd=t()})(typeof window!="undefined"?window:this,function(){var e,t,r;return function(n){function d(e,t){return h.call(e,t)}function v(e,t){var n,r,i,s,o,u,a,f,c,h,p=t&&t.split("/"),d=l.map,v=d&&d["*"]||{};if(e&&e.charAt(0)===".")if(t){p=p.slice(0,p.length-1),e=p.concat(e.split("/"));for(f=0;f<e.length;f+=1){h=e[f];if(h===".")e.splice(f,1),f-=1;else if(h===".."){if(f===1&&(e[2]===".."||e[0]===".."))break;f>0&&(e.splice(f-1,2),f-=2)}}e=e.join("/")}else e.indexOf("./")===0&&(e=e.substring(2));if((p||v)&&d){n=e.split("/");for(f=n.length;f>0;f-=1){r=n.slice(0,f).join("/");if(p)for(c=p.length;c>0;c-=1){i=d[p.slice(0,c).join("/")];if(i){i=i[r];if(i){s=i,o=f;break}}}if(s)break;!u&&v&&v[r]&&(u=v[r],a=f)}!s&&u&&(s=u,o=a),s&&(n.splice(0,o,s),e=n.join("/"))}return e}function m(e,t){return function(){return s.apply(n,p.call(arguments,0).concat([e,t]))}}function g(e){return function(t){return v(t,e)}}function y(e){return function(t){a[e]=t}}function b(e){if(d(f,e)){var t=f[e];delete f[e],c[e]=!0,i.apply(n,t)}if(!d(a,e)&&!d(c,e))throw new Error("No "+e);return a[e]}function w(e){var t,n=e?e.indexOf("!"):-1;return n>-1&&(t=e.substring(0,n),e=e.substring(n+1,e.length)),[t,e]}function E(e){return function(){return l&&l.config&&l.config[e]||{}}}var i,s,o,u,a={},f={},l={},c={},h=Object.prototype.hasOwnProperty,p=[].slice;o=function(e,t){var n,r=w(e),i=r[0];return e=r[1],i&&(i=v(i,t),n=b(i)),i?n&&n.normalize?e=n.normalize(e,g(t)):e=v(e,t):(e=v(e,t),r=w(e),i=r[0],e=r[1],i&&(n=b(i))),{f:i?i+"!"+e:e,n:e,pr:i,p:n}},u={require:function(e){return m(e)},exports:function(e){var t=a[e];return typeof t!="undefined"?t:a[e]={}},module:function(e){return{id:e,uri:"",exports:a[e],config:E(e)}}},i=function(e,t,r,i){var s,l,h,p,v,g=[],w=typeof r,E;i=i||e;if(w==="undefined"||w==="function"){t=!t.length&&r.length?["require","exports","module"]:t;for(v=0;v<t.length;v+=1){p=o(t[v],i),l=p.f;if(l==="require")g[v]=u.require(e);else if(l==="exports")g[v]=u.exports(e),E=!0;else if(l==="module")s=g[v]=u.module(e);else if(d(a,l)||d(f,l)||d(c,l))g[v]=b(l);else{if(!p.p)throw new Error(e+" missing "+l);p.p.load(p.n,m(i,!0),y(l),{}),g[v]=a[l]}}h=r?r.apply(a[e],g):undefined;if(e)if(s&&s.exports!==n&&s.exports!==a[e])a[e]=s.exports;else if(h!==n||!E)a[e]=h}else e&&(a[e]=r)},e=t=s=function(e,t,r,a,f){return typeof e=="string"?u[e]?u[e](t):b(o(e,t).f):(e.splice||(l=e,t.splice?(e=t,t=r,r=null):e=n),t=t||function(){},typeof r=="function"&&(r=a,a=f),a?i(n,e,t,r):setTimeout(function(){i(n,e,t,r)},4),s)},s.config=function(e){return l=e,l.deps&&s(l.deps,l.callback),s},e._defined=a,r=function(e,t,n){t.splice||(n=t,t=[]),!d(a,e)&&!d(f,e)&&(f[e]=[e,t,n])},r.amd={jQuery:!0}}(),r("vendor/almond",function(){}),r("common",[],function(){var e={};return e.err=null,e.errors={ERR_VERSION:"bad xml or unknown smile version",ERR_BAD_TIME:"bad time (control) data"},e.builtins={max:{},min:{},pulse:{usesTime:!0}},e.reserved={"if":!0,then:!0,"else":!0},e}),r("util",["./common"],function(e){function s(e,t){var n=t[0],r=t.slice(1),i=[],o,u;for(u in e.childNodes)o=e.childNodes[u],o.tagName&&o.tagName.toLowerCase()===n&&(r.length?i=i.concat(s(o,r)):i.push(o));return i}var t={};t.titleCase=function(t){return t.replace(/(?:^|\s)\w/g,function(e){return e.toUpperCase()})},t.dName=function(t){return t.replace(/\\n/g,"\n").replace(/_/g," ")},t.eName=function(t){return typeof t!="string"?"":t.replace(/\\n/g,"_").replace(/\s/g,"_").toLowerCase()};var n=["start","stop","dt","savestep"];t.normalizeTimespec=function(t){if(!t)return;t.savestep||(t.savestep=t.dt),t["@method"]||(t["@method"]="euler")},t.set=function(){var t={},n;for(n=0;n<arguments.length;++n)t[arguments[n]]=!0;return t};var r=function(t,n,r){var i=t[n];t[n]=t[r],t[r]=i},i=function(t,n,i,s){var o=t[s];r(t,s,i);var u,a=n;for(u=n;u<i;++u)t[u].lessThan(o)&&(r(t,u,a),a+=1);return r(t,a,i),a};return t.partitionNum=function(t,n,i,s){var o=t[s];r(t,s,i);var u,a=n;for(u=n;u<i;++u)t[u]<o&&(r(t,u,a),a+=1);return r(t,a,i),a},t.sort=function o(e,t,n,r){t===undefined&&(t=0,n=e.length-1),r||(r=i);if(t>=n)return;var s=Math.floor(t+(n-t)/2),u=r(e,t,n,s);o(e,t,u-1,r),o(e,u+1,n,r)},t.lookup=function(t,n){var r=t.x.length;if(r===0)return NaN;var i=t.x,s=t.y;if(n<=i[0])return s[0];if(n>=i[r-1])return s[r-1];var o=0,u=r,a;while(o<u)a=Math.floor(o+(u-o)/2),i[a]<n?o=a+1:u=a;var f=o;if(i[f]===n)return s[f];var l=(s[f]-s[f-1])/(i[f]-i[f-1]);return(n-i[f-1])*l+s[f-1]},t.min=function(t,n){return t<n?t:n},t.numArr=function(t){var n=[],r;for(r=0;r<t.length;r++)n.push(parseFloat(t[r]));return n},t.floatAttr=function(t,n){return parseFloat(t.getAttribute(n))},t.qs=function(t,n){if(t.querySelector)return t.querySelector(n);var r=n.split(">"),i=t,s,o,u;e:for(s=0;i&&s<r.length;s++){for(o=0;o<i.childNodes.length;o++){u=i.childNodes[o];if(!u.tagName)continue;if(u.tagName.toLowerCase()===r[s].toLowerCase()){i=u;continue e}}i=null}return i},t.qsa=function(t,n){if(t.querySelectorAll)return t.querySelectorAll(n);var r=n.split(">").map(function(e){return e.toLowerCase()});return s(t,r)},t.isNaN=function(t){return t!==t},t}),r("lex",["./common","./util"],function(e,t){function u(e,t,n,r){this.tok=e,this.type=t,this.startLoc=n,this.endLoc=r}function a(e,t){this.line=e,this.pos=t}function f(e){this.textOrig=e,this.text=e.toLowerCase(),this._len=e.length,this._pos=0,this._peek=this.text[0],this._line=0,this._lineStart=0}var n={};n.TOKEN="token",n.IDENT="word",n.RESERVED="reserved",n.NUMBER="number";var r=t.set("if","then","else"),i=function(t){return/\s/.test(t)},s=function(t){return/[\d\.]/.test(t)},o=function(t){return/[\w_]/.test(t)};return f.prototype._getChar=function(){return this._pos<this._len-1?(this._pos+=1,this._peek=this.text[this._pos]):this._peek=null,this._peek},f.prototype._skipWhitespace=function(){do{this._peek==="\n"&&(this._line+=1,this._lineStart=this._pos+1);if(!i(this._peek))break}while(this._getChar()!==null)},f.prototype._fastForward=function(e){this._pos+=e,this._pos<this._len?this._peek=this.text[this._pos]:this._peek=null},f.prototype._lexIdentifier=function(e){var t=/[\w_][\w\d_]*/.exec(this.text.substring(this._pos))[0],i=t.length;this._fastForward(i);var s;return t in r?s=n.RESERVED:s=n.IDENT,new u(t,s,e,new a(e.line,e.pos+i))},f.prototype._lexNumber=function(e){var t=/\d*(\.\d*)?(e(\d+(\.\d*)?)?)?/.exec(this.text.substring(this._pos))[0],r=t.length,i=parseFloat(t);return this._fastForward(r),new u(i,n.NUMBER,e,new a(e.line,e.pos+r))},f.prototype.getToken=function(){this._skipWhitespace();var e=this._peek;if(e===null||e===undefined)return null;var t=this._pos-this._lineStart,r=new a(this._line,t);switch(e){case"=":return this._getChar(),this._peek==="="?(this.getChar(),new u("==",n.TOKEN,r,new a(this._line,t+2))):new u("=",n.TOKEN,r,new a(this._line,t+1));default:}return s(e)?this._lexNumber(r):o(e)?this._lexIdentifier(r):(this._getChar(),new u(e,n.TOKEN,r,new a(this._line,t+1)))},n.Scanner=f,n.identifierSet=function(r){var i=new n.Scanner(r),s={},o=0,u;while(u=i.getToken())if(u.tok==="{")o++;else if(u.tok==="}")o--;else{if(o>0)continue;u.type===n.IDENT&&!(u.tok in e.builtins)&&(s[u.tok]=!0)}return s},n}),r("ast",[],function(){function e(e,t){this.name=t,this._pos=e}function t(e,t){this.value=t,this._pos=e}function n(e,t,n){this.x=t,this._lPos=lPos,this._rPos=rPos}function r(e,t,n,r){this.fun=e,this.args=n,this._lParenPos=t,this._rParenPos=r}function i(e,t,n){this.op=t,this.x=n,this._opPos=e}function s(e,t,n,r){this.x=e,this.op=n,this.y=r,this._opPos=t}function o(e,t,n,r,i,s){this.cond=t,this.a=r,this.b=s,this._ifPos=e,this._thenPos=n,this._elsePos=i}return e.prototype.pos=function(){return this._pos},t.prototype.pos=function(){return this._pos},n.prototype.pos=function(){return this._lPos},r.prototype.pos=function(){return this.fun.pos()},i.prototype.pos=function(){return this._opPos},s.prototype.pos=function(){return this.x.pos()},o.prototype.pos=function(){return this._ifPos},e.prototype.end=function(){return this._pos+this.name.length},t.prototype.end=function(){return this._pos+this.value.length},n.prototype.end=function(){return this._rPos+1},r.prototype.end=function(){return this._rParenPos+1},i.prototype.end=function(){return this.x.end()},s.prototype.end=function(){return this.y.end()},o.prototype.end=function(){return this.b.end()},{Ident:e}}),r("parse",["./ast","./lex"],function(e,t){function n(e){var t=new r(e),n=t.parse();return t.errs.length?[null,t.errs]:[n,null]}function r(e){this.lex=new t.Scanner(e),this.levels=[i(0,this,"^"),i(1,this,"*/"),i(2,this,"+-"),this.factor]}function i(t,n,r){return function(){if(!n.lex.peek())return null;var i=n.levels[t+1],s=i();if(!s)return;var o;for(o=n.consumeAnyOf(r);o;o=n.consumeAnyOf(r)){var u=i();if(!u)return;s=e.BinaryExpr(s,0,o,u)}return s}}return r.prototype.parse=function(){return this.levels[0]()},r.prototype.factor=function(){return null},r.prototype.consumeAnyOf=function(e){var n=p.lex.peek();if(!n||n.type!==t.TOKEN)return},{parse:n}}),r("vars",["./util","./common","./lex","./parse"],function(e,t,n,r){var i=function(r,i){if(arguments.length===0)return;this.model=r,this.xmile=i;var s=i.eqn.toString().toLowerCase();this.eqn=s,this.name=e.eName(i["@name"]),this._deps=n.identifierSet(s)};i.prototype.initialEquation=function(){return this.eqn},i.prototype.code=function(r){if(this.isConst())return"this.initials['"+e.eName(this.name)+"']";var i=new n.Scanner(this.eqn),s=[],o=0,u,a;while(a=i.getToken())if(a.tok==="{")o++;else if(a.tok==="}")o--;else{if(o>0)continue;if(a.tok in t.reserved)switch(a.tok){case"if":break;case"then":s.push("?");break;case"else":s.push(":")}else a.type!==n.IDENT?s.push(a.tok):a.tok in t.builtins?(s.push(a.tok),t.builtins[a.tok].usesTime&&(i.getToken(),u=this.model.name==="main"?"curr":"globalCurr",s.push("(","dt",",",u+"[0]",","))):a.tok in r?s.push("curr["+r[a.tok]+"]"):s.push('globalCurr[this.ref["'+a.tok+'"]]')}return s.length||s.push("0"),s.join(" ")},i.prototype.getDeps=function(){if(this._allDeps)return this._allDeps;var e={},t,n,r,i;for(n in this._deps){if(n in e)continue;e[n]=!0,t=this.model.vars[n];if(!t)continue;i=t.getDeps();for(r in i)e[r]=!0}return this._allDeps=e,e},i.prototype.lessThan=function(e){return this.name in e.getDeps()},i.prototype.isConst=function(){return isFinite(this.eqn)};var s=function(r,i){this.model=r,this.xmile=i;var s=i.eqn.toString().toLowerCase();this.name=e.eName(i["@name"]),this.initial=s,this.eqn=s,i.inflow||(i.inflow=[]),i.inflow instanceof Array||(i.inflow=[i.inflow]),i.outflow||(i.outflow=[]),i.outflow instanceof Array||(i.outflow=[i.outflow]),this.inflows=i.inflow.map(function(t){return e.eName(t)}),this.outflows=i.outflow.map(function(t){return e.eName(t)}),this._deps=n.identifierSet(s)};s.prototype=new i,s.prototype.initialEquation=function(){return this.initial},s.prototype.code=function(e){var t="curr["+e[this.name]+"] + (";return this.inflows.length>0&&(t+=this.inflows.map(function(t){return"curr["+e[t]+"]"}).join("+")),this.outflows.length>0&&(t+="- ("+this.outflows.map(function(t){return"curr["+e[t]+"]"}).join("+")+")"),this.inflows.length===0&&this.outflows.length===0&&(t+="0"),t+=")*dt",t};var o=function(r,i){this.model=r,this.xmile=i;var s=i.eqn.toString().toLowerCase();this.eqn=s,this.name=e.eName(i["@name"]),this.x=[],this.y=[];var o,u;typeof i.gf.ypts=="object"?(u=i.gf.ypts["@sep"]||",",o=e.numArr(i.gf.ypts.keyValue.split(u))):o=e.numArr(i.gf.ypts.split(","));var a=null;typeof i.gf.xpts=="object"?(u=i.gf.xpts["@sep"]||",",a=e.numArr(i.gf.xpts.keyValue.split(u))):i.gf.xpts&&(a=e.numArr(i.gf.xpts.split(",")));var f=i.gf.xscale,l=f?f["@min"]:0,c=f?f["@max"]:0,h=0,p=0;for(h=0;h<o.length;h++)a?p=a[h]:p=h/(o.length-1)*(c-l)+l,this.x.push(p),this.y.push(o[h]);this._deps=n.identifierSet(s)};o.prototype=new i,o.prototype.code=function(){if(!this.eqn)return null;var e=i.prototype.code.apply(this,arguments);return"lookup(this.tables['"+this.name+"'], "+e+")"};var u=function(n,r,i){this.project=n,this.parent=r,this.xmile=i,this.name=e.eName(i["@name"]),this.modelName=this.name,i.connect||(i.connect=[]),i.connect instanceof Array||(i.connect=[i.connect]),this.refs={},this._deps={};var s,o,u;for(s=0;s<i.connect.length;s++)u=new a(i.connect[s]),this.refs[u.name]=u,this._deps[u.ptr]=!0};u.prototype=new i,u.prototype.getDeps=function(){if(this._allDeps)return this._allDeps;var e={},t,n,r,i,o,u;for(n in this._deps){if(n in e)continue;n[0]==="."?(o=this.project.model(this.project.main.modelName),n=n.substr(1)):o=this.parent,u=n.split("."),t=o.lookup(n);if(!t){console.log("couldnt find "+n);continue}t instanceof s||(e[u[0]]=!0),i=t.getDeps();for(r in i)e[r]=!0}return this._allDeps=e,e},u.prototype.referencedModels=function(e){e||(e={});var t=this.project.model(this.modelName),n=t.name;e[n]?e[n].modules.push(this):e[n]={model:t,modules:[this]};var r;for(r in t.modules)t.modules[r].referencedModels(e);return e};var a=function(n){this.xmile=n,this.name=e.eName(n["@to"]),this.ptr=e.eName(n["@from"])};return a.prototype=new i,a.prototype.code=function(){return'curr["'+this.ptr+'"]'},a.prototype.lessThan=function(e){return this.ptr in e.getDeps()},a.prototype.isConst=function(){return!1},{Variable:i,Stock:s,Table:o,Module:u,Reference:a}}),r("runtime",[],function(){var e={};return e.preamble="/* jshint globalstrict: true, unused: false */\n/* global cmds: false, TIME: false, DEBUG: false */\n\n\nvar i32 = function i32(n) {\n    return n|0;\n};\n\nvar Simulation = function() {};\nSimulation.prototype.lookupOffset = function(id) {\n    //print(this.name + ': ' + id + ' resolving (' + this._shift + ')');\n    if (id === 'time')\n        return 0;\n    if (id[0] === '.')\n        id = id.substr(1);\n    if (id in this.offsets)\n        return this._shift + this.offsets[id];\n    var parts = id.split('.');\n    if (parts.length === 1 && id === \"\" && this.name in this.offsets)\n        return this._shift + this.offsets[this.name];\n    var nextSim = this.modules[parts[0]];\n    if (!nextSim)\n        return -1;\n    return nextSim.lookupOffset(parts.slice(1).join('.'));\n};\nSimulation.prototype.resolveAllSymbolicRefs = function() {\n    var n, ctx;\n    for (n in this.symRefs) {\n        if (this.symRefs[n][0] === '.')\n            ctx = main;\n        else\n            ctx = this.parent;\n        this.ref[n] = ctx.lookupOffset(this.symRefs[n]);\n        //print(this.name + ': ' + n + ' resolved to ' + this.ref[n]);\n    }\n    for (n in this.modules)\n        this.modules[n].resolveAllSymbolicRefs();\n};\nSimulation.prototype.varNames = function() {\n    var result = Object.keys(this.offsets).slice();\n    var ids;\n    for (v in this.modules) {\n        ids = this.modules[v].varNames().map(function(n) {\n            return v + '.' + n;\n        });\n        result = result.concat(ids);\n    }\n    if (this.name === 'main')\n        result.push('time');\n\n    return result;\n}\nSimulation.prototype.getNVars = function() {\n    var nVars = Object.keys(this.offsets).length;\n    var n;\n    for (n in this.modules)\n        nVars += this.modules[n].getNVars();\n    // if we're main, claim time\n    if (this.name === 'main')\n        nVars++;\n    return nVars;\n};\nSimulation.prototype.reset = function() {\n    var timespec = this.timespec;\n    var nSaveSteps = i32((timespec.stop - timespec.start)/timespec.savestep + 1);\n\n    this.stepNum = 0;\n\n    this.slab = new Float64Array(this.nVars*(nSaveSteps + 1));\n\n    var curr = this.curr();\n    curr[TIME] = timespec.start;\n    this.saveEvery = Math.max(1, i32(timespec.savestep/timespec.dt+0.5));\n\n    this.calcInitial(this.timespec.dt, curr);\n};\nSimulation.prototype.runTo = function(endTime) {\n    var dt = this.timespec.dt;\n\n    var curr = this.curr();\n    var next = this.slab.subarray((this.stepNum+1)*this.nVars,\n                                  (this.stepNum+2)*this.nVars);\n\n    while (curr[TIME] <= endTime) {\n        this.calcFlows(dt, curr);\n        this.calcStocks(dt, curr, next);\n\n        next[TIME] = curr[TIME] + dt;\n\n        if (this.stepNum++ % this.saveEvery !== 0) {\n            curr.set(next);\n        } else {\n            curr = next;\n            next = this.slab.subarray((i32(this.stepNum/this.saveEvery)+1)*this.nVars,\n                                      (i32(this.stepNum/this.saveEvery)+2)*this.nVars);\n        }\n    }\n};\nSimulation.prototype.runToEnd = function() {\n    return this.runTo(this.timespec.stop + 0.5*this.timespec.dt);\n};\nSimulation.prototype.curr = function() {\n    return this.slab.subarray((this.stepNum)*this.nVars,\n                              (this.stepNum+1)*this.nVars);\n};\nSimulation.prototype.setValue = function(name, value) {\n    var off = this.lookupOffset(name);\n    if (off === -1)\n        return;\n    this.curr()[off] = value;\n};\nSimulation.prototype.value = function(name) {\n    var off = this.lookupOffset(name);\n    if (off === -1)\n        return;\n    var saveNum = i32(this.stepNum/this.saveEvery);\n    var slabOff = this.nVars*saveNum;\n    return this.slab.subarray(slabOff, slabOff + this.nVars)[off];\n};\nSimulation.prototype.series = function(name) {\n    var saveNum = i32(this.stepNum/this.saveEvery);\n    var time = new Float64Array(saveNum);\n    var values = new Float64Array(saveNum);\n    var off = this.lookupOffset(name);\n    if (off === -1)\n        return;\n    //print(this.name + ': ' + name + ' resolved to ' + off);\n    var i, curr;\n    for (i=0; i < time.length; i++) {\n        curr = this.slab.subarray(i*this.nVars, (i+1)*this.nVars);\n        time[i] = curr[0];\n        values[i] = curr[off];\n    }\n    return {\n        'name': name,\n        'time': time,\n        'values': values,\n    };\n};\n\nfunction handleMessage(e) {\n    var id = e.data[0];\n    var cmd = e.data[1];\n    var args = e.data.slice(2);\n    var result;\n\n    if (cmds.hasOwnProperty(cmd))\n        result = cmds[cmd].apply(null, args);\n    else\n        result = [null, 'unknown command \"' + cmd + '\"'];\n\n    if (!Array.isArray(result))\n        result = [null, 'no result for [' + e.data.join(', ') + ']'];\n\n    // TODO(bp) look into transferrable objects\n    var msg = [id, result];\n    postMessage(msg);\n}\n\nvar desiredSeries = null;\n\nfunction initCmds(main) {\n    return {\n        'reset': function() {\n            main.reset();\n            return ['ok', null];\n        },\n        'set_val': function(name, val) {\n            main.setValue(name, val);\n            return ['ok', null];\n        },\n        'get_val': function() {\n            var result = {};\n            var i;\n            for (i=0; i < arguments.length; i++)\n                result[arguments[i]] = main.value(arguments[i]);\n            return [result, null];\n        },\n        'get_series': function() {\n            var result = {};\n            var i;\n            for (i=0; i<arguments.length; i++)\n                result[arguments[i]] = main.series(arguments[i]);\n            return [result, null];\n        },\n        'run_to': function(time) {\n            main.runTo(time);\n            return [main.value('time'), null];\n        },\n        'run_to_end': function() {\n            var result = {};\n            var i;\n            main.runToEnd();\n            if (desiredSeries) {\n                for (i = 0; i < desiredSeries.length; i++)\n                    result[desiredSeries[i]] = main.series(desiredSeries[i]);\n                return [result, null];\n            } else {\n                return [main.value('time'), null];\n            }\n        },\n        'set_desired_series': function(names) {\n            desiredSeries = names;\n            return ['ok', null];\n        },\n    };\n}\n\nfunction lookup(table, index) {\n    var size = table.x.length;\n    if (size === 0)\n        return NaN;\n\n    var x = table.x;\n    var y = table.y;\n\n    if (index <= x[0])\n        return y[0];\n    else if (index >= x[size - 1])\n        return y[size - 1];\n\n    // binary search seems to be the most appropriate choice here.\n    var low = 0;\n    var high = size;\n    var mid;\n    while (low < high) {\n        mid = Math.floor(low + (high - low)/2);\n        if (x[mid] < index) {\n            low = mid + 1;\n        } else {\n            high = mid;\n        }\n    }\n\n    var i = low;\n    if (x[i] === index) {\n        return y[i];\n    } else {\n        // slope = deltaY/deltaX\n        var slope = (y[i] - y[i-1]) / (x[i] - x[i-1]);\n        // y = m*x + b\n        return (index - x[i-1])*slope + y[i-1];\n    }\n}\n\nfunction max(a, b) {\n    a = +a;\n    b = +b;\n    return a > b ? a : b;\n}\n\nfunction min(a, b) {\n    a = +a;\n    b = +b;\n    return a < b ? a : b;\n}\n\nfunction pulse(dt, time, volume, firstPulse, interval) {\n    if (time < firstPulse)\n        return 0;\n    var nextPulse = firstPulse;\n    while (time >= nextPulse) {\n        if (time < nextPulse + dt)\n            return volume/dt;\n        else if (interval <= 0.0)\n            break;\n        else\n            nextPulse += interval;\n    }\n    return 0;\n}",e.epilogue="/* global main: false, print: true, mainMapping: false */\n\nif (typeof console !== 'undefined')\n    print = console.log;\n\nmain.runToEnd();\nvar series = {};\nvar header = 'time\\t';\nvar vars = main.varNames();\nvar i, v;\nfor (i = 0; i < vars.length; i++) {\n    v = vars[i];\n    if (v === 'time')\n        continue;\n    header += v + '\\t';\n    series[v] = main.series(v);\n}\nprint(header.substr(0, header.length-1));\n\nvar nSteps = main.series('time').time.length;\nvar msg = '';\nfor (i = 0; i < nSteps; i++) {\n    msg = '';\n    for (v in series) {\n        if (msg === '')\n            msg += series[v].time[i] + '\\t';\n        msg += series[v].values[i] + '\\t';\n    }\n    print(msg.substr(0, msg.length-1));\n}",e.drawCSS='<defs><style>\n/* <![CDATA[ */\n.spark-axis {\n    stroke-width: 0.125;\n    stroke-linecap: round;\n    stroke: #999;\n    fill: none;\n}\n\n.spark-line {\n    stroke-width: 0.5;\n    stroke-linecap: round;\n    stroke: #2299dd;\n    fill: none;\n}\n\ntext {\n    font-size: 12px;\n    font-family: "Open Sans";\n    font-weight: 300;\n    text-anchor: middle;\n    white-space: nowrap;\n    vertical-align: middle;\n}\n\n.left-aligned {\n    text-anchor: start;\n}\n/* ]]> */\n</style></defs>\n',e}),r("draw",["./util","./vars","./runtime"],function(e,t,n){var r=9,i=6,s=1,o="M 25.731189,3.8741489 C 21.525742,3.8741489 18.07553,7.4486396 17.497605,12.06118 C 16.385384,10.910965 14.996889,10.217536 13.45908,10.217535 C 9.8781481,10.217535 6.9473481,13.959873 6.9473482,18.560807 C 6.9473482,19.228828 7.0507906,19.875499 7.166493,20.498196 C 3.850265,21.890233 1.5000346,25.3185 1.5000346,29.310191 C 1.5000346,34.243794 5.1009986,38.27659 9.6710049,38.715902 C 9.6186538,39.029349 9.6083922,39.33212 9.6083922,39.653348 C 9.6083922,45.134228 17.378069,49.59028 26.983444,49.590279 C 36.58882,49.590279 44.389805,45.134229 44.389803,39.653348 C 44.389803,39.35324 44.341646,39.071755 44.295883,38.778399 C 44.369863,38.780301 44.440617,38.778399 44.515029,38.778399 C 49.470875,38.778399 53.499966,34.536825 53.499965,29.310191 C 53.499965,24.377592 49.928977,20.313927 45.360301,19.873232 C 45.432415,19.39158 45.485527,18.91118 45.485527,18.404567 C 45.485527,13.821862 42.394553,10.092543 38.598118,10.092543 C 36.825927,10.092543 35.215888,10.918252 33.996078,12.248669 C 33.491655,7.5434856 29.994502,3.8741489 25.731189,3.8741489 z",u=55,a=4,f=8,l=6,c=5,h={"font-size":"12px","font-family":"Open Sans","font-weight":"300","text-anchor":"middle","white-space":"nowrap","vertical-align":"middle"},p="gray",d="black",v={flow:1,module:2,stock:3,aux:4,connector:5},m=6,g=typeof navigator!="undefined"&&navigator.userAgent.match(/Chrome/),y=e.dName,b=e.eName,w=function(t,n){return t.hasOwnProperty(n)},E=function(t){return Math.abs(t)<1e-7},S=e.isNaN,x=function(t){return Math.pow(t,2)},T=function(t,n){return{x:t,y:n}},N=e.floatAttr,C={0:"right",1:"bottom",2:"left",3:"top"},k=function(t,n){n||(n="bottom");var r,i,s;return"@label_side"in t?(s=t["@label_side"].toLowerCase(),s==="center"?n:s):"@label_angle"in t?(r=(t["@label_angle"]+45)%360,i=r/90|0,C[i]):n},L=function(t,n,i){var s=r*2/u,a="matrix("+s+", 0, 0, "+s+", "+(n-r)+", "+(i-r)+")";return t.path(o).attr({fill:"#ffffff",stroke:"#6388dc","stroke-width":2,"stroke-linejoin":"round","stroke-miterlimit":4}).transform(a)},A=function(e,t,n){var r=x(t.x)+x(t.y),i=(x(e.x)+x(e.y)-r)/2,s=(r-x(n.x)-x(n.y))/2,o=(e.x-t.x)*(t.y-n.y)-(t.x-n.x)*(e.y-t.y);if(E(o)){console.log("blerg");return}var u=1/o,a=(i*(t.y-n.y)-s*(e.y-t.y))*u,f=(s*(e.x-t.x)-i*(t.x-n.x))*u;return{x:a,y:f,r:Math.sqrt(Math.pow(t.x-a,2)+Math.pow(t.y-f,2))}},O=function(t,n,s,o,u,a,f){a=a||r,f=f||r;var l,c;switch(o){case"top":l=n,c=s-f-i;break;case"bottom":l=n,c=s+f+i;break;case"left":l=n-a-i,c=s;break;case"right":l=n+a+i,c=s}var p=t.text(l,c,u.split("\n")).attr(h),d=p.attr("text");typeof d=="string"&&(d=[d]);var v=p.node.getElementsByTagName("tspan"),m,y,b,w=Number.MIN_VALUE,E=Number.MIN_VALUE;if(g)for(m=0;m<v.length;m++)b=v[m].getBBox(),b.height>w&&(w=b.height),b.width>E&&(E=b.width);else for(m=0;m<d.length;m++)y=t.text(0,0,d[m]).attr(h),b=y.getBBox(),b.height>w&&(w=b.height),b.width>E&&(E=b.width),y.remove();for(m=0;m<v.length;m++)o==="left"||o==="right",m>0&&(o==="left"?v[m].setAttribute("x",l-E/2):v[m].setAttribute("x",l),v[m].setAttribute("dy",.7*w));var S;switch(o){case"bottom":p.attr({y:c+i});break;case"top":p.attr({y:c-(v.length-1)*(w/2)-i*(v.length>1)});break;case"left":v.length>1?S=(v.length-2)*(w/2):S=-w/4,p.attr({y:c-S,x:l-E/2});break;case"right":p.node.classList.add("left-aligned"),p.node.setAttribute("style",p.node.getAttribute("style").replace("middle","left")),p.attr({y:c-(v.length-2)*(w/2)})}return p},M=function(t){return t[t.length-1]},_=function(t,n,r,i){var s="M"+n+","+r+"L"+(n-i)+","+(r+i/2)+"A"+i*3+","+i*3+" 0 0,1 "+(n-i)+","+(r-i/2)+"z";return t.path(s)},D=function(t,n,r,i,s,o,u,a){var f=n-i/2,l=r-s/2,c=o[0],h=M(o),p=h-c,d=Math.min(0,Math.min.apply(null,u)),v=Math.max.apply(null,u),m=v-d||1,g="",y;for(y=0;y<u.length;y++)S(u[y])&&console.log("NaN at "+o[y]),g+=(y===0?"M":"L")+(f+i*(o[y]-c)/p)+","+(l+s-s*(u[y]-d)/m);var b="M"+f+","+(l+s-s*(0-d)/m)+"L"+(f+i)+","+(l+s-s*(0-d)/m);if(!a)return t.g(t.path(b).attr({"class":"spark-axis","stroke-width":.125,"stroke-linecap":"round",stroke:"#999",fill:"none"}),t.path(g).attr({"class":"spark-line","stroke-width":.5,"stroke-linecap":"round",stroke:"#2299dd",fill:"none"}));var w=a.node.querySelector(".spark-line");return w.setAttribute("d",g),a},P=function(e,t){this.drawing=e,this.e=t,this.name=b(t["@name"]),this.dName=y(t["@name"]),this.cx=t["@x"],this.cy=t["@y"],this.w=45,this.h=35,this.color=this.drawing.colorOverride?d:t["@color"]||d,this.labelSide=k(t)};P.prototype.init=function(){var e=this.drawing.model.vars[this.name],t,n,r;for(t=0;t<e.inflows.length;t++){n=e.inflows[t],r=this.drawing.named_ents[n];if(!r){console.log("failed connecting "+this.name+" .to "+n);continue}r.to=this.name}for(t=0;t<e.outflows.length;t++){n=e.outflows[t],r=this.drawing.named_ents[n];if(!r){console.log("failed connecting "+this.name+" .from "+n);continue}this.drawing.named_ents[n].from=this.name}},P.prototype.draw=function(){var e=this.drawing.paper,t=this.w,n=this.h;this.set=this.drawing.group(e.rect(Math.ceil(this.cx-t/2),Math.ceil(this.cy-n/2),t,n).attr({fill:"white","stroke-width":s,stroke:this.color}))},P.prototype.drawLabel=function(){var e=this.drawing.paper,t=this.w,n=this.h;this.set.add(O(e,this.cx,this.cy,this.labelSide,this.dName,t/2,n/2))},P.prototype.visualize=function(e,t){var n=!!this.graph;this.graph=D(this.drawing.paper,this.cx,this.cy,this.w-4,this.h-4,e,t,this.graph),n||this.set.add(this.graph)};var H=function(e,t){this.drawing=e,this.e=t,this.name=b(t["@name"]),this.dName=y(t["@name"]),this.cx=t["@x"],this.cy=t["@y"],this.w=55,this.h=45,this.color=this.drawing.colorOverride?d:t["@color"]||d,this.labelSide=k(t)};H.prototype.init=function(){},H.prototype.draw=function(){var e=this.drawing.paper,t=this.w,n=this.h;this.set=this.drawing.group(e.rect(Math.ceil(this.cx-t/2),Math.ceil(this.cy-n/2),t,n,c,c).attr({fill:"white","stroke-width":s,stroke:this.color}))},H.prototype.drawLabel=function(){var e=this.drawing.paper,t=this.w,n=this.h;this.set.add(O(e,this.cx,this.cy,this.labelSide,this.dName,t/2,n/2))},H.prototype.visualize=function(e,t){var n=!!this.graph;this.graph=D(this.drawing.paper,this.cx,this.cy,this.w-6,this.h-6,e,t,this.graph),n||this.set.add(this.graph)};var B=function(e,t){this.drawing=e,this.e=t,this.name=b(t["@name"]),this.dName=y(t["@name"]),this.cx=t["@x"],this.cy=t["@y"],this.color=this.drawing.colorOverride?d:t["@color"]||d,this.labelSide=k(t)};B.prototype.init=function(){},B.prototype.draw=function(){var e=this.drawing.paper;this.set=this.drawing.group(e.circle(this.cx,this.cy,r).attr({fill:"white","stroke-width":s,stroke:this.color}))},B.prototype.drawLabel=function(){var e=this.drawing.paper;this.set.add(O(e,this.cx,this.cy,this.labelSide,this.dName))},B.prototype.visualize=function(e,t){var n=!!this.graph;this.graph=D(this.drawing.paper,this.cx,this.cy,r,r,e,t,this.graph),n||this.set.add(this.graph)};var j=function(e,t){this.drawing=e,this.e=t,this.name=b(t["@name"]),this.dName=y(t["@name"]),this.cx=t["@x"],this.cy=t["@y"],this.to=null,this.from=null,this.color=this.drawing.colorOverride?d:t["@color"]||d,this.labelSide=k(t)};j.prototype.init=function(){},j.prototype.draw=function(){var e=this.drawing.paper,t=this.cx,n=this.cy,i=this.e.pts.pt;if(i.length<2){console.log("ERROR: too few points for flow: "+JSON.stringify(this));return}var o="",u;for(u=0;u<i.length;u++)o+=(u===0?"M":"L")+i[u]["@x"]+","+i[u]["@y"];var l,c;this.set=this.drawing.group(),this.from||(c=L(e,i[0]["@x"],i[0]["@y"]),l=c);var h,p,d,v;this.to||(h=i[i.length-1]["@x"],p=i[i.length-1]["@y"],d=i[i.length-2]["@x"],v=i[i.length-2]["@y"],c=L(e,h,p),this.set.add(c),d<h&&(i[i.length-1]["@x"]=h-f),d>h&&(i[i.length-1]["@x"]=h+f),v<p&&(i[i.length-1]["@y"]=p-f),v>p&&(i[i.length-1]["@y"]=p+f)),o="";var m,g,y,b,w;for(u=0;u<i.length;u++)h=i[u]["@x"],p=i[u]["@y"],u===i.length-1&&(m=h-i[u-1]["@x"],g=p-i[u-1]["@y"],y=Math.atan2(g,m)*180/Math.PI,y<0&&(y+=360),y>=315||y<45?(h-=4,b=0):y>=45&&y<135?(p-=4,b=90):y>=135&&y<225?(h+=4,b=180):(p+=4,b=270)),o+=(u===0?"M":"L")+h+","+p;this.set.add(e.path(o).attr({"stroke-width":s*4,stroke:this.color,fill:"none"})),w=M(i),this.set.add(_(e,w["@x"],w["@y"],a*2).attr({transform:"rotate("+b+","+w["@x"]+","+w["@y"]+")",stroke:this.color,"stroke-width":1,fill:"white","stroke-linejoin":"round"})),this.set.add(e.path(o).attr({stroke:"white","stroke-width":s*2,fill:"none"})),this.set.add(e.circle(t,n,r).attr({fill:"white","stroke-width":s,stroke:this.color})),l&&this.set.append(l)},j.prototype.drawLabel=function(){var e=this.drawing.paper;this.set.add(O(e,this.cx,this.cy,this.labelSide,this.dName))},j.prototype.visualize=function(e,t){var n=!!this.graph;this.graph=D(this.drawing.paper,this.cx,this.cy,r,r,e,t,this.graph),n||this.set.add(this.graph)};var F=function(e,t){this.drawing=e,this.e=t,this.name=undefined,this.color=this.drawing.colorOverride?p:t["@color"]||p};F.prototype.init=function(){},F.prototype.draw=function(){var e=this.drawing.paper,t=this.e["@x"],n=this.e["@y"],i=this.drawing.named_ents[b(this.e.from)];if(!i)return;var o=i.cx,u=i.cy,f=this.drawing.named_ents[b(this.e.to)];if(!f)return;var c=f.cx,h=f.cy,p=A(T(t,n),T(o,u),T(c,h)),d="",v=0;d+="M"+t+","+n;var m,g,y,w,E,S,x;if(p){m=o-p.x,g=u-p.y,y=Math.atan2(g,m)*180/Math.PI,m=c-p.x,g=h-p.y,w=Math.atan2(g,m)*180/Math.PI,E=w-y;while(E<0)E+=360;E%=360,v=E<=180-l,f instanceof H?x=25:x=r,S=Math.tan(x/p.r)*180/Math.PI,c=p.x+p.r*Math.cos((w+(v?-1:1)*S)/180*Math.PI),h=p.y+p.r*Math.sin((w+(v?-1:1)*S)/180*Math.PI),d+="A"+p.r+","+p.r+" 0 0,"+(v?"1":"0")+" "+c+","+h}else m=c-o,g=h-u,w=Math.atan2(g,m)*180/Math.PI,d+="L"+c+","+h;var N=0;if(p){var C=-Math.atan2(c-p.x,h-p.y);N=C*180/Math.PI,v&&(N+=180)}this.set=this.drawing.group(e.path(d).attr({"stroke-width":s/2,stroke:this.color,fill:"none"}),e.circle(t,n,2).attr({"stroke-width":0,fill:"#c83639"}),_(e,c,h,a).attr({transform:"rotate("+N+","+c+","+h+")",stroke:this.color,"stroke-width":1,fill:this.color,"stroke-linejoin":"round"}))},F.prototype.drawLabel=function(){};var I={stock:P,flow:j,aux:B,connector:F,module:H},q=function(e,t,r,i,s){this.model=e,this.xmile=t;var o;typeof r=="string"?(r.length>0&&r[0]==="#"&&(r=r.substr(1)),o=document.getElementById(r)):o=r,o.innerHTML="",this.paper=new Snap(o);var u=o.getElementsByTagName("defs")[0];u?u.outerHTML=n.drawCSS:o.innerHTML+=n.drawCSS,this._selector=r,this._g=this.paper.g(),this._g.node.id="viewport",this.colorOverride=i,o.setAttribute("preserveAspectRatio","xMinYMin");var a="translateZ(0px)";o.style["-webkit-transform"]=a,o.style["-moz-transform"]=a,o.style["-ms-transform"]=a,o.style["-o-transform"]=a,o.style.transform=a;var f=[],l,c;for(l in I){if(!(l in t))continue;t[l]instanceof Array||(t[l]=[t[l]]);for(c=0;c<t[l].length;c++)t[l][c]["@tagName"]=l,f.push(t[l][c])}this.d_ents=[],this.z_ents=new Array(m);for(c=0;c<m;c++)this.z_ents[c]=[];this.named_ents={};var h,p,d,g;for(c=0;c<f.length;c++){p=f[c],g=p["@tagName"];if(!g)continue;if(!w(I,g)){console.log("unknown draw ent type "+p.tagName);continue}d=new I[g](this,p),this.d_ents.push(d),this.z_ents[v[g]].push(d),d.name&&(this.named_ents[d.name]=d)}for(c=0;c<this.d_ents.length;c++)this.d_ents[c].init();for(c=0;c<m;c++)for(h=0;h<this.z_ents[c].length;h++)this.z_ents[c][h].draw();for(c=0;c<m;c++)for(h=0;h<this.z_ents[c].length;h++)this.z_ents[c][h].drawLabel();this._t={scale:1,offX:0,offY:0,x:0,y:0,dx:0,dy:0};var y=this;o.onmousedown=function(e){var t=y;t.dragStart={x:e.pageX,y:e.pageY}},o.onmousemove=function(e){var t=y;if(!t.dragStart)return;t._t.dx=e.pageX-t.dragStart.x,t._t.dy=e.pageY-t.dragStart.y,t.transform()},o.onmouseup=function(){var e=y;e._t.x+=e._t.dx,e._t.y+=e._t.dy,e._t.offX=e._t.x,e._t.offY=e._t.y,e._t.dx=0,e._t.dy=0,e.dragStart=null};if(!s)return;o.onmousewheel=function(e){var t=y,n=e.wheelDelta/120;t._t.scale+=.2*n,t.transform()},o.onDOMMouseScroll=function(e){var t=y,n=-e.detail/3;t._t.scale+=.2*n,t.transform()}};return q.prototype.transform=function(e,t,n){arguments.length===3&&(this._t.scale=e,this._t.x=t,this._t.y=n);var r="translateZ(0px) matrix("+this._t.scale+",0,0,"+this._t.scale+","+(this._t.x+this._t.dx)+","+(this._t.y+this._t.dy)+")";this._g.node.style["-webkit-transform"]=r,this._g.node.style["-moz-transform"]=r,this._g.node.style["-ms-transform"]=r,this._g.node.style.transform=r},q.prototype.visualize=function(e){if(e.project){var t=e,n=this;t.series.apply(t,Object.keys(this.named_ents)).then(function(e){var t,r,i;for(t in e){i=e[t],r=n.named_ents[t];if(!r){console.log("sim data for non-drawn "+t);continue}r.visualize(i.time,i.values)}}).done()}else{var r=e,i,s;for(i in r){e=r[i],s=this.named_ents[i];if(!s){console.log("sim data for non-drawn "+i);continue}s.visualize(e.time,e.values)}}},q.prototype.group=function(){var e=this.paper.g.apply(this.paper,arguments);return this._g.append(e),e},{Drawing:q}}),r("sim",["./util","./vars","./runtime"],function(e,t,r){var i=!0,s=i?"    ":"",o=i?"\n    ":"",u=0,a="{{&preamble}}\n\nvar TIME = 0;\n\n{{#models}}\nvar {{&className}} = function {{&className}}(name, parent, offset, symRefs) {\n    this.name = name;\n    this.parent = parent;\n    this._shift = i32(offset);\n    {{&init}}\n    this.modules = {{&modules}};\n    this.symRefs = symRefs || {};\n    this.ref = {};\n    this.nVars = this.getNVars();\n    if (name === 'main')\n        this.reset();\n};\n{{&className}}.prototype = new Simulation();\n{{&className}}.prototype.initials = {{&initialVals}};\n{{&className}}.prototype.timespec = {{&timespecVals}};\n{{&className}}.prototype.offsets = {{&offsets}};\n{{&className}}.prototype.tables = {{&tableVals}};\n{{&className}}.prototype.calcInitial = function(dt, curr) {\n    dt = +dt;\n{{#isModule?}}\n    var globalCurr = curr;\n    curr = curr.subarray(this._shift, this._shift + this.nVars);\n{{/isModule?}}\n    {{&calcI}}\n};\n{{&className}}.prototype.calcFlows = function(dt, curr) {\n    dt = +dt;\n{{#isModule?}}\n    var globalCurr = curr;\n    curr = curr.subarray(this._shift, this._shift + this.nVars);\n{{/isModule?}}\n    {{&calcF}}\n};\n{{&className}}.prototype.calcStocks = function(dt, curr, next) {\n    dt = +dt;\n{{#isModule?}}\n    var globalCurr = curr;\n    curr = curr.subarray(this._shift, this._shift + this.nVars);\n    next = next.subarray(this._shift, this._shift + this.nVars);\n{{/isModule?}}\n    {{&calcS}}\n};\n\n{{/models}}\nvar main = new {{&mainClassName}}('main');\nmain.resolveAllSymbolicRefs();\n\nvar cmds = initCmds(main);\n\n{{&epilogue}}\n",f=function(n,i){this.project=n.project,this.seq=1,this.promised={},this.idSeq={};var s=n.referencedModels(),o=[],u;for(u in s)u==="main"?this.idSeq[u]=1:this.idSeq[u]=0,o.push(this._process(s[u].model,s[u].modules));var f=Mustache.render(a,{preamble:r.preamble,epilogue:i?r.epilogue:"onmessage = handleMessage;",mainClassName:e.titleCase(n.modelName),models:o});if(i){console.log(f);return}var l=new Blob([f],{type:"text/javascript"});this.worker=new Worker(window.URL.createObjectURL(l)),l=null,f=null;var c=this;this.worker.addEventListener("message",function(e){var t=e.data[0],n=e.data[1],r=c.promised[t];delete c.promised[t],r&&(n[1]?r.reject(n[1]):r.resolve(n[0]))})};return f.prototype._process=function(r,u){var a=[],f=[],l=[],c=function(t){var n;for(n=0;n<u.length;n++)if(t in u[n].refs)return!0;return!1},h={},p={},d,v;for(n in r.vars)d=r.vars[n],d instanceof t.Module?(a.push(d),f.push(d),l.push(d)):d instanceof t.Stock?(a.push(d),l.push(d)):d instanceof t.Table?f.push(d):d.isConst()?(a.push(d),l.push(d)):f.push(d),!(d instanceof t.Module)&&!c(n)&&(v=this.nextID(r),p[n]=v,i?h[n]=v+"/*"+n+"*/":h[n]=v);e.sort(a),e.sort(f);var m={},g={},y=[],b=[],w=[],E,d,S;for(E=0;E<a.length;E++){d=a[E];if(d instanceof t.Module)S='this.modules["'+d.name+'"].calcInitial(dt, curr);';else{if(c(d.name))continue;d.isConst()&&(m[d.name]=parseFloat(d.eqn)),S="curr["+h[d.name]+"] = "+t.Variable.prototype.code.apply(d,[h])+";"}y.push(S)}for(E=0;E<f.length;E++){d=f[E],S=null,d instanceof t.Module?S='this.modules["'+d.name+'"].calcFlows(dt, curr);':c(d.name)||(S="curr["+h[d.name]+"] = "+d.code(h)+";");if(!S)continue;b.push(S)}for(E=0;E<l.length;E++)d=l[E],d instanceof t.Module?w.push('this.modules["'+d.name+'"].calcStocks(dt, curr, next);'):d.hasOwnProperty("initial")?w.push("next["+h[d.name]+"] = "+d.code(h)+";"):w.push("next["+h[d.name]+"] = curr["+h[d.name]+"];");for(n in r.tables)g[n]={x:r.tables[n].x,y:r.tables[n].y};var x="",T=[];Object.keys(r.modules).length&&(r.name==="main"&&(x=" + 1"),T.push("var off = Object.keys(this.offsets).length"+x+";"));var u=["{"],N;for(n in r.modules){T.push("var "+n+"Refs = {");for(N in r.modules[n].refs)T.push('    "'+N+'": "'+r.modules[n].refs[N].ptr+'",');T.push("};"),T.push("var "+n+" = new "+e.titleCase(r.modules[n].modelName)+'("'+n+'", this, off, '+n+"Refs);"),T.push("off += "+n+".nVars;"),u.push('    "'+n+'": '+n+",")}return u.push("}"),{name:r.name,className:e.titleCase(r.name),"isModule?":r.name!=="main",modules:u.join(o),init:T.join(o),initialVals:JSON.stringify(m,null,s),timespecVals:JSON.stringify(r.timespec,null,s),tableVals:JSON.stringify(g,null,s),calcI:y.join(o),calcF:b.join(o),calcS:w.join(o),offsets:JSON.stringify(p,null,s)}},f.prototype.nextID=function(e){return this.idSeq[e.name]++},f.prototype._post=function(){var e=this.seq++,t=[e],n;for(n=0;n<arguments.length;n++)t.push(arguments[n]);var r=Q.defer();return this.promised[e]=r,this.worker.postMessage(t),r.promise},f.prototype.close=function(){this.worker.terminate(),this.worker=null},f.prototype.reset=function(){return this._post("reset")},f.prototype.setValue=function(e,t){return this._post("set_val",e,t)},f.prototype.value=function(){var e=["get_val"].concat(Array.prototype.slice.call(arguments));return this._post.apply(this,e)},f.prototype.series=function(){var e=["get_series"].concat(Array.prototype.slice.call(arguments));return this._post.apply(this,e)},f.prototype.runTo=function(e){return this._post("run_to",e)},f.prototype.runToEnd=function(){return this._post("run_to_end")},f.prototype.setDesiredSeries=function(e){return this._post("set_desired_series",e)},{Sim:f}}),r("model",["./util","./vars","./common","./draw","./sim"],function(e,t,n,r,i){var s=e.set("module","stock","aux","flow"),o=function(n,r){this.project=n,this.xmile=r,this.name=e.eName(r["@name"]),this._parseVars(r.variables),r.sim_specs?this._timespec=r.sim_specs:this._timespec=null,e.normalizeTimespec(this._timespec),this.valid=!0;return};return o.prototype={get timespec(){return this._timespec?this._timespec:this.project.timespec}},o.prototype._parseVars=function(e){this.vars={},this.tables={},this.modules={};var n,r;for(r in s)e[r]&&!(e[r]instanceof Array)&&(e[r]=[e[r]]);var i,o=0;if(e.module)for(o=0;o<e.module.length;o++)n=e.module[o],i=new t.Module(this.project,this,n),this.modules[i.name]=i,this.vars[i.name]=i;var u;if(e.stock)for(o=0;o<e.stock.length;o++)n=e.stock[o],u=new t.Stock(this,n),this.vars[u.name]=u;var a;if(e.aux)for(o=0;o<e.aux.length;o++)n=e.aux[o],n.gf?(a=new t.Table(this,n),this.tables[a.name]=a):a=new t.Variable(this,n),this.vars[a.name]=a;var f;if(e.flow)for(o=0;o<e.flow.length;o++)n=e.flow[o],n.gf?(a=new t.Table(this,n),this.tables[a.name]=a):a=new t.Variable(this,n),this.vars[a.name]=a},o.prototype.lookup=function(e){e[0]==="."&&(e=e.substr(1));if(e in this.vars)return this.vars[e];var t=e.split("."),n=this.project.models[this.modules[t[0]].modelName];return n.lookup(t.slice(1).join("."))},o.prototype.sim=function(e){return this.name==="main"?new i.Sim(this.project.main,e):new i.Sim(new t.Module(this.project,null,"main",this.name),e)},o.prototype.drawing=function(e,t,n){return new r.Drawing(this,this.xmile.views.view[0],e,t,n)},{Model:o}}),r("jxon",[],function(){function e(e){return typeof e=="object"}function t(e){return e=e.trim(),/^\s*$/.test(e)?null:/^(?:true|false)$/i.test(e)?e.toLowerCase()==="true":isFinite(e)?parseFloat(e):e}function n(e){var r=!0,i="",s=0,o=0,u,a,f,l;if(e.hasAttributes()){r={};for(s=0;s<e.attributes.length;s++)u=e.attributes.item(s),r["@"+u.name.toLowerCase()]=t(u.value)}if(e.hasChildNodes())for(o=0;o<e.childNodes.length;o++){a=e.childNodes.item(o);switch(a.nodeType){case 4:i+=a.nodeValue;break;case 3:i+=a.nodeValue.trim();break;case 1:s||(r={},s++),f=a.nodeName.toLowerCase(),l=n(a),r.hasOwnProperty(f)?(r[f]instanceof Array||(r[f]=[r[f]]),r[f].push(l)):r[f]=l}}return i&&(s?r.keyValue=i:r=t(i)),r}function r(e){}return{JXON:{build:n,unbuild:r}}}),r("compat",["./util"],function(e){function s(e){return/isee/i.test(e.header.vendor)}function o(e){var s,o,u,a,f;for(s=0;s<e.model.length;s++){u=e.model[s],u.views={},u.views.view=[],u.views&&(u.views.view.push(u.display),delete u.display),u.interface&&(u.interface["@name"]="interface",u.views.view.push(u.interface),delete u.interface),u.variables={};for(a in i){if(!u[a])continue;u.variables[a]=u[a],delete u[a],u.variables[a]instanceof Array||(u.variables[a]=[u.variables[a]]),u.views.view[0][a]||(u.views.view[0][a]=[]);for(o=0;o<u.variables[a].length;o++)f=u.variables[a][o].display,f["@name"]=u.variables[a][o]["@name"],"label_side"in f&&(f["@label_side"]=f.label_side,delete f.label_side),u.views.view[0][a].push(f),delete u.variables[a][o].display}}return e.header.vendor=t,e.header.product={"@version":r,keyValue:n},e.header.version=r,e}var t="SDLabs",n="sd.js",r="0.1",i=e.set("module","stock","aux","flow");return{isee:{match:s,translate:o}}}),r("project",["./common","./util","./model","./vars","./jxon","./compat"],function(e,t,n,r,i,s){var o=i.JXON,u=e.errors,a=t.qs,f=t.qsa,l=function(i){e.err=null;if(!i||i.getElementsByTagName("parsererror").length!==0){e.err=u.ERR_VERSION,this.valid=!1;return}var a=0;while(a<i.childNodes.length&&i.childNodes.item(a).tagName!=="xmile")a++;var f=o.build(i.childNodes.item(a));f.model instanceof Array||(f.model=[f.model]);var l;for(l in s)s[l].match(f)&&(f=s[l].translate(f));if(f.header.smile["@version"]!==1){e.err=u.ERR_VERSION,this.valid=!1;return}this.xmile=f,typeof f.header.name=="string"?this.name=f.header.name:this.name="main project",this.timespec=f.sim_specs;if(!this.timespec){this.valid=!1;return}t.normalizeTimespec(this.timespec),this.models={};var a,c;for(a=0;a<f.model.length;a++)c=f.model[a],c["@name"]||(c["@name"]="main"),this.models[c["@name"]]=new n.Model(this,c);this.main=new r.Module(this,null,{"@name":"main"}),this.valid=!0};return l.prototype.model=function(e){return e||(e="main"),this.models[e]},{Project:l}}),r("sd",["./common","./project","./model"],function(e,t,n){var r={};return r.Project=t.Project,r.Model=n.Model,r.newModel=function(e){var t=new r.Project(e);return t.valid?t.model():null},r.load=function(e,t,n){var i=new XMLHttpRequest;i.onreadystatechange=function(){if(i.readyState!==4)return;if(i.status>=200&&i.status<300){var e=i.responseXML;e||(e=(new DOMParser).parseFromString(i.responseText,"application/xml"));var s=r.newModel(e);t(s)}else n&&n(i)},i.open("GET",e,!0),i.send()},r.errors=e.errors,r.error=function(){return e.err},r}),t("sd")});