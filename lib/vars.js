...
define(['./util', './common', './lex'], function(util, common, lex) {
    ...
    const Table = function Table(name, eqn, gf) {
        ...
        //console.log(name+'.ypts: '+gf.children('ypts').text());
        ...
        //const ymin = parseFloat(gf.children('yscale').attr('min'));
        //const ymax = parseFloat(gf.children('yscale').attr('max'));
        ...
        for (i = 0; i < ypts.length; i++) {
            ...
            //console.log('x:'+x+',y:'+ypts[i]);
            this.x.push(x);
            this.y.push(ypts[i]);
        }
        //console.log(name+'.x = ' + this.x);
        //console.log(name+'.y = ' + this.y);
