...
define(['./util', './common', './lex'], function(util, common, lex) {
    ...
    var Module = function Module(model, name, params) {
        this.model = model;
        this.name = util.eName(name);
        this.type = 'module';
        this.params = params;
    ...
    Module.prototype.lessThan = function() {
        // TODO(bp) implement in terms of params
        return false;
    };

    var Reference = function Reference(model, name, other) {
        this.model = model;
        this.name = util.eName(name);
        this.ptr = other;
        this._deps = [util.eName(other)];
    };
    Reference.prototype = new Variable();
    Reference.prototype.equation = function() {
