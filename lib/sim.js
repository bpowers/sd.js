...
define(['./util', './vars', './runtime'], function(util, vars, runtime) {
    ...
    var tmpl = "{{&preamble}}\n\n" +
        ...
        "{{&className}}.prototype.modules = {{&modules}};\n" +
    ...
    var Sim = function Sim(project, isStandalone) {
        ...
        var models = rootModel.referencedModels();
    ...
    Sim.prototype._process = function(model, module) {
        var initials = {};
        var tables = {};
        ...
        for (i = 0; i < model.initials.length; i++) {
            ...
            ci.push("curr[" + offsets[n] + "] = " + vars.Variable.prototype.code.apply(v, [offsets]) + ';');
        }
