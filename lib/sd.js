...
define(['./util', './vars'], function(util, vars) {
    sd = {};
    ...
    var ERR_VERSION  = sd.ERR_VERSION  = "bad xml or unknown smile version";
    var ERR_BAD_TIME = sd.ERR_BAD_TIME = "bad time (control) data";
    ...
    */
	...
	// TODO: **** add .isLessThan(other) to Variable.  And
	// refactor Variables in general.
