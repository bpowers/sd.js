...
define('compat',["require", "exports", './util'], function (require, exports, util) {
    var VENDOR = 'SDLabs';
    var PRODUCT = 'sd.js';
    var VERSION = '0.1';
...
define('runtime',["require", "exports"], function (require, exports) {
    ...
    exports.epilogue = "/// <reference path=\"./generated.d.ts\" />\nvar pr;\nif (typeof console === 'undefined') {\n    pr = print;\n}\nelse {\n    pr = console.log;\n}\nmain.runToEnd();\nexports.series = {};\nexports.header = 'time\\t';\nexports.vars = main.varNames();\nfor (var i = 0; i < exports.vars.length; i++) {\n    var v = exports.vars[i];\n    if (v === 'time')\n        continue;\n    exports.header += v + '\\t';\n    exports.series[v] = main.series(v);\n}\npr(exports.header.substr(0, exports.header.length - 1));\nexports.nSteps = main.series('time').time.length;\nfor (var i = 0; i < exports.nSteps; i++) {\n    var msg = '';\n    for (var v in exports.series) {\n        if (!exports.series.hasOwnProperty(v))\n            continue;\n        if (msg === '')\n            msg += exports.series[v].time[i] + '\\t';\n        msg += exports.series[v].values[i] + '\\t';\n    }\n    pr(msg.substr(0, msg.length - 1));\n}\n//# sourceMappingURL=epilogue.js.map";
