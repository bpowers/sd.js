...
import {SourceLoc, Token, TokenType} from '../lib/type';
...
const LEX_TESTS: LexTestData[] = [
	...
	},
	{
		in: "å",
		out: [
			new Token("å", TokenType.IDENT, loc, loc),
		]
	},
	{
		in: "a1_åbc________",
		out: [
			new Token("a1_åbc________", TokenType.IDENT, loc, loc),
		]
	},
	{
	...
	// exponent 'e' is case insensitive
	{
		in: "5E4",
		out: [
			new Token("5e4", TokenType.NUMBER, loc, loc),
		]
	},
	{
		in: "5e4",
	...
	},
	{
		...
		out: [
			new Token("5.0000000000000e4.00000000000000", TokenType.NUMBER, loc, loc),
		]
	},
	{
		in: "3",
	...
	},
	{
		...
		out: [
			new Token("-", TokenType.TOKEN, loc, loc),
			new Token("3.222", TokenType.NUMBER, loc, loc),
		]
	},
	{
		in: "-30000.222",
		out: [
			new Token("-", TokenType.TOKEN, loc, loc),
			new Token("30000.222", TokenType.NUMBER, loc, loc),
		]
	},
	{
		in: "5.3e4.",
		out: [
			new Token("5.3e4.", TokenType.NUMBER, loc, loc),
		]
	},
	{
		in: "3 == 4 \n\n= 1",
